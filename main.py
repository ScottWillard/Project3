...
class GameGraphTraversalApp(wx.Frame):
    ...
    def InitUI(self):
        ...
        # Build Graph button
        build_graph_button = wx.Button(panel, label="Build Graph", size=(150, -1))  # Narrower button
        ...
        self.graph_progress_bar = wx.Gauge(panel, range=1, size=(500, 25))  # Reduced size for the progress bar

        # Start Traversals buttons
        bfs_button = wx.Button(panel, label="Breadth First Search", size=(150, -1))  # Narrower button
        bfs_button.Bind(wx.EVT_BUTTON, self.OnStartBFS)
        dfs_button = wx.Button(panel, label="Depth First Search", size=(150, -1))  # Narrower button
        ...
        self.bfs_progress_bar = wx.Gauge(panel, range=1, size=(500, 25))  # Reduced size for the progress bar
        self.dfs_progress_label = wx.StaticText(panel, label="Depth First Search")
        self.dfs_progress_bar = wx.Gauge(panel, range=1, size=(500, 25))  # Reduced size for the progress bar
        ...
        clear_results_button = wx.Button(panel, label="Clear Results", size=(150, -1))  # Narrower button
    ...
    def bfs_traversal(self, starting_nodes, result_text):
        ...
        for i in range(num_intervals + 1):
            ...
            wx.CallAfter(self.bfs_progress_bar.SetValue, progress_value)  # Update progress bar
